...
class Settings(BaseSettings):
    ...
    codetr_runtime_backend: str = "subprocess"
    codetr_repo_path: str = "third_party/Co-DETR"
    codetr_python_path: str = ".codetr-cu121/bin/python"
    codetr_config_path: str = "third_party/Co-DETR/projects/configs/co_dino/co_dino_5scale_r50_1x_coco.py"
    codetr_checkpoint_path: str = "models/codetr/co_dino_5scale_r50_1x_coco.pth"
    codetr_device: str = "cuda:0"
    codetr_startup_timeout_sec: float = 120.0
    codetr_request_timeout_sec: float = 30.0
